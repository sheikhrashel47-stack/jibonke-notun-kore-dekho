...
## Six-book store expansion

- [x] User-provided prompts for five additional books reviewed.
- [x] Six-book catalog entries and detail routes integrated without removing the three existing books.
- [x] Generated visual-philosophy illustrations and five premium cover assets published to stable release storage.
- [x] Main and scroll readers updated for lazy illustration blocks.
- [x] Service worker updated to runtime-cache GitHub-hosted book images after first load.
- [x] `pnpm check && pnpm build` passed locally.
- [ ] Complete all remaining long-form chapters, visual pages, and full book PDFs before describing the six books as fully complete.
- [ ] Verify live GitHub Pages deployment and mobile routes.
