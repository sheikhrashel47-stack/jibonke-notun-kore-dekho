...
export const bookDefinitions: Record<BookId, BookDefinition> = {
  life: {
    ...
    cover: `${import.meta.env.BASE_URL}jibon-cover.webp`,
    accent: "#1B5E45",
    accentSoft: "#E6F0E8",
    chapters,
    chapterLoaders,
  ...
  dark: {
    ...
    category: "মনোবিজ্ঞান",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}dark-psychology-cover.webp`,
    accent: "#17395A",
    accentSoft: "#E7EEF6",
  ...
  thinking: {
    ...
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}the-art-of-thinking-cover.webp`,
    accent: "#56447A",
    accentSoft: "#EEEAF5",
  ...
  presence: {
    ...
    category: "মনোবিজ্ঞান",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}presence-code-cover.png`,
    accent: "#8A4B2A",
    accentSoft: "#F6E9DF",
  ...
  wealth: {
    ...
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}the-wealth-code-cover.webp`,
    accent: "#0B5B4B",
    accentSoft: "#E8F2ED",
