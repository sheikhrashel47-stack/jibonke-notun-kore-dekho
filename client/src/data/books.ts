...
export const bookDefinitions: Record<BookId, BookDefinition> = {
  life: {
    ...
    cover: `${import.meta.env.BASE_URL}covers/jibon-cover.webp`,
    accent: "#1B5E45",
    accentSoft: "#E6F0E8",
    chapters,
    chapterLoaders,
  ...
  dark: {
    ...
    category: "মনোবিজ্ঞান",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/dark-psychology-cover.webp`,
    accent: "#17395A",
    accentSoft: "#E7EEF6",
  ...
  thinking: {
    ...
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/the-art-of-thinking-cover.webp`,
    accent: "#56447A",
    accentSoft: "#EEEAF5",
  ...
  presence: {
    ...
    category: "মনোবিজ্ঞান",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/presence-code-cover.webp`,
    accent: "#8A4B2A",
    accentSoft: "#F6E9DF",
  ...
  habit: {
    ...
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/habit-architect-cover.webp`,
    accent: "#2A6B4F",
    accentSoft: "#E6F1E9",
  ...
  brain: {
    ...
    creator: "শেখ রাসেল",
    cover: `${import.meta.env.BASE_URL}covers/brain-boost-cover.webp`,
    accent: "#D5A83C",
    accentSoft: "#F5EED7",
  ...
  wealth: {
    ...
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/the-wealth-code-cover.webp`,
    accent: "#0B5B4B",
    accentSoft: "#E8F2ED",
  ...
  communication: {
    ...
    category: "চিন্তা ও সিদ্ধান্ত",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/kothar-shilpo-cover.webp`,
    accent: "#7A3040",
    accentSoft: "#F5E9E4",
  ...
  future: {
    ...
    creator: "Zayan",
    cover: `${import.meta.env.BASE_URL}covers/the-future-cover.webp`,
    accent: "#0B5D66",
    accentSoft: "#E4F1F2",
  ...
  "return-allah": {
    ...
    creator: "Zayan",
    cover: `${import.meta.env.BASE_URL}covers/return-to-allah-cover.webp`,
    accent: "#153B4A",
    accentSoft: "#E8F1F2",
  ...
  "mistakes-cost-lives": {
    ...
    category: "চিন্তা ও সিদ্ধান্ত",
    creator: "Zayan",
    cover: `${import.meta.env.BASE_URL}covers/mistakes-cost-lives-cover.webp`,
    accent: "#183F4B",
    accentSoft: "#F2E7DE",
  ...
  intelligence: {
    ...
    category: "চিন্তা ও সিদ্ধান্ত",
    creator: "Zayan",
    cover: `${import.meta.env.BASE_URL}covers/intelligence-code-cover.webp`,
    accent: "#6B4E9B",
    accentSoft: "#EEE8F8",
  ...
  "winning-mind": {
    ...
    category: "জীবনচর্চা",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/winning-mind-cover.webp`,
    accent: "#102A43",
    accentSoft: "#E8F0F7",
  ...
  "ai-mastery-wealth": {
    ...
    category: "অর্থ ও সম্পদ",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/ai-mastery-wealth-cover.webp`,
    accent: "#C8942E",
    accentSoft: "#F4EDDC",
  ...
  "house-remembered": {
    ...
    category: "মনোবিজ্ঞান",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/house-that-remembered-cover.webp`,
    accent: "#2B1D2E",
    accentSoft: "#F1E9F0",
  ...
  "hard-truth": {
    ...
    category: "চিন্তা ও সিদ্ধান্ত",
    creator: "Zayan",
    cover: `${import.meta.env.BASE_URL}covers/hard-truth-cover.webp`,
    accent: "#9B3E22",
    accentSoft: "#F3E5DD",
  ...
  "law-everyone-should-know": {
    ...
    category: "জীবনচর্চা",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/law-everyone-should-know-cover.webp`,
    accent: "#0B1F2A",
    accentSoft: "#E7EEF2",
  ...
  "last-words": {
    ...
    category: "জীবনচর্চা",
    creator: "Zayan",
    cover: `${import.meta.env.BASE_URL}covers/last-words-cover.webp`,
    accent: "#6E5A78",
    accentSoft: "#EEE8F1",
  ...
  "second-timer": {
    ...
    category: "মস্তিষ্ক ও শেখা",
    creator: "JIBON Editorial",
    cover: `${import.meta.env.BASE_URL}covers/second-timer-cover.webp`,
    accent: "#B47A2C",
    accentSoft: "#F5EBD9",
  ...
  knowledge: {
    ...
    creator: "শেখ রাসেল",
    cover: `${import.meta.env.BASE_URL}covers/knowledge-book-cover.webp`,
    accent: "#214E5A",
    accentSoft: "#E6F1F2",
  ...
  "somajer-aina": {
    ...
    category: "চিন্তা ও সিদ্ধান্ত",
    creator: "শেখ রাসেল",
    cover: `${import.meta.env.BASE_URL}covers/somajer-aina-cover.webp`,
    accent: "#174B3B",
    accentSoft: "#EEF4EE",
