...
const defaultState: ReaderState = {
  ...
  activeBookId: "life",
  activeChapterId: "01",
  lastChapterByBook: { life: "01", dark: "01", thinking: "01", presence: "01", habit: "01", brain: "01", wealth: "01", communication: "001", future: "01", intelligence: "01", "winning-mind": "001", "ai-mastery-wealth": "001" },
  lastPositionByBook: {},
  libraryBookIds: ["life"],
};
