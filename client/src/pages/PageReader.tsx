...
export default function PageReader() {
  ...
  return <div className="page-shell pdf-reader-page"><AppHeader /><main className="pdf-reader">
    <header className="pdf-reader__header"><div><p className="store-eyebrow"><FileText className="size-4" /> {book.title} · {book.pdfPageCount.toLocaleString("bn-BD")} নকশা-পৃষ্ঠা</p><h1>নির্দিষ্ট পৃষ্ঠায় পড়ো</h1><p>নিজের গতিতে পড়ো, খেয়াল করো, তারপর একটি ছোট প্রয়োগ বেছে নাও।</p></div><Link href={`/book/${book.id}/chapter/${firstChapterId}`} className="pdf-reader__chapter-link"><BookOpen className="size-4" /> অধ্যায়ভিত্তিক পড়া</Link></header>
