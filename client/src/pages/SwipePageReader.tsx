/* জীবন-ড্যাশবোর্ড: a native-feeling one-page reader; vertical scrolling stays free and only deliberate horizontal swipes turn pages. */
...
export default function SwipePageReader() {
  ...
  return <div className="page-shell swipe-reader-page"><AppHeader /><div className="swipe-reader-layout"><ChapterSidebar bookId={book.id} currentChapterId={currentChapterMeta?.id} mode="swipe" /><main className="swipe-reader">
    ...
    <section className="swipe-reader__workspace" aria-label="PDF পৃষ্ঠা পড়ুন"><div className="swipe-reader__paper" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}><PdfPageCanvas source={book.pdfUrl} page={page} /><span className="swipe-reader__page-cue">ডানে বা বাঁয়ে টেনে পাতা বদলাও</span></div></section>
